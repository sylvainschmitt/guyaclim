...
```{r sensors}
readxl::read_xlsx("data/Paracou_TOMST_ALT/metadata.xlsx") %>% 
  tail() %>% 
  knitr::kable()
```
...
```{r campaign}
readxl::read_xlsx("data/Paracou_TOMST_ALT/20240920.xlsx") %>% 
  head() %>% 
  knitr::kable()
```
...
```{r campaigns}
readxl::read_xlsx("data/Paracou_TOMST_ALT/campaigns.xlsx") %>% 
  head() %>% 
  knitr::kable()
```
