...
The general idea is to test the development of a clean and automated
database of consolidated raw microclimate data from microsensors
(TOMOST, HOBO, …) in French Guiana.

## Usage

**guyaclim** analyses rely on the quarto documents `index.qmd` that can
